...
(function($) {
    ...
    // Pull Header
    $(".header-pull menu ul li.menu-item-has-children > a").on(
        "click",
        function() {
    ...
    if (navbarFix.length) {
        ...
        $(window).on("scroll", function() {
            if ($(window).scrollTop() > headerOffset) {
                ...
                $("#js-navbar-fixed .menu-wrapper .menu ul li a").css("color", "black");
            } else {
                navbarFix.removeClass("fixed");
                $("#js-navbar-fixed .menu-wrapper .menu ul li a").css("color", "white");
            }
        });
    }
    ...
    function n() {
        ...
        d.imagesLoaded(function(e) {
            ...
            if ($(window).width() < 778) {
                d.isotope(g);
                d.isotope("layout");
                if ($(".section-content").getNiceScroll())
                    $(".section-content").getNiceScroll().remove();
            } else {
                d.isotope(f);
                d.isotope("layout");
                $(".section-content").niceScroll(c);
    ...
    $(".single-course-content .curriculum-content  li").on("click", function() {
        $(".single-course-content .curriculum-content")
            .find(".active")
            .removeClass("active");
        $(this).addClass("active");
    });
